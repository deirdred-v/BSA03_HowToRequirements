...
Резюме:
Выявление бизнес-требований, построение функционально-ролевых моделей и документирование требований.
...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Role-playing game (Ролевая игра)](#51) \
    2.2. [Exercise 01 — Brainstorming (Проведение мозгового штурма)](#52) \
    2.3. [Exercise 02 — Seminar (Семинар)](#53) \
    2.4. [Exercise 03 — Vision (Видение)](#54)
